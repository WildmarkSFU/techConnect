import { javascriptLanguage as s, LRLanguage as P, LanguageSupport as q, styleTags as g, tags as r, html as c, parseMixed as i, LRParser as R, ExternalTokenizer as p } from "../../../editor.js";
...
}), o = { parser: V }, w = { parser: s.parser }, U = /* @__PURE__ */ Q.configure({
  wrap: /* @__PURE__ */ i((O, e) => O.name == "InterpolationContent" ? o : null)
...
function S(O) {
  return O.configure({ wrap: i(z) }, "angular");
}
...
function G(O = {}) {
  ...
  return new q(e.language == l.language ? k : S(e.language), [e.support, e.language.data.of({
