import { ExternalTokenizer as P, ContextTracker as G, styleTags as k, tags as i, LRParser as E, syntaxTree as _, ifNotIn as U, LRLanguage as z, indentNodeProp as j, delimitedIndent as $, foldNodeProp as A, foldInside as F, LanguageSupport as I, IterMode as N, completeFromList as C, NodeWeakMap as D, snippetCompletion as S } from "../../../editor.js";
...
const jO = p(R, 1, M, K, OO), AO = p(u, 1, rO, oO, aO), FO = p(R, 3, iO, eO, QO), IO = p(u, 3, xO, SO, sO), NO = k({
  ...
  ".": i.derefOperator,
  ", ;": i.separator
}), CO = { __proto__: null, await: 48, or: 58, and: 60, in: 64, not: 66, is: 68, if: 74, else: 76, lambda: 80, yield: 98, from: 100, async: 106, for: 108, None: 178, True: 180, False: 180, del: 194, pass: 198, break: 202, continue: 206, return: 210, raise: 218, import: 222, as: 224, global: 228, nonlocal: 230, assert: 234, type: 239, elif: 252, while: 256, try: 262, except: 264, finally: 266, with: 270, def: 274, class: 284, match: 295, case: 301 }, DO = E.deserialize({
  version: 14,
