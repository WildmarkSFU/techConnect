import { styleTags as X, tags as O, LRParser as e, LRLanguage as r, indentNodeProp as s, continuedIndent as $, flatIndent as S, delimitedIndent as l, foldNodeProp as Z, foldInside as Y, LanguageSupport as t } from "../../../editor.js";
const n = X({
  null: O.null,
  ...
  specialized: [{ term: 230, get: (Q) => o[Q] || -1 }],
  tokenPrec: 6995
}), T = /* @__PURE__ */ r.define({
  name: "java",
  parser: /* @__PURE__ */ c.configure({
    props: [
      /* @__PURE__ */ s.add({
        IfStatement: /* @__PURE__ */ $({ except: /^\s*({|else\b)/ }),
        TryStatement: /* @__PURE__ */ $({ except: /^\s*({|catch|finally)\b/ }),
        LabeledStatement: S,
        SwitchBlock: (Q) => {
          let P = Q.textAfter, a = /^\s*\}/.test(P), i = /^\s*(case|default)\b/.test(P);
          return Q.baseIndent + (a ? 0 : i ? 1 : 2) * Q.unit;
        },
        Block: /* @__PURE__ */ l({ closing: "}" }),
        BlockComment: () => null,
        Statement: /* @__PURE__ */ $({ except: /^{/ })
      }),
      /* @__PURE__ */ Z.add({
        "Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody ConstructorBody InterfaceBody ArrayInitializer": Y,
        BlockComment(Q) {
