import { LRLanguage as t, indentNodeProp as i, continuedIndent as n, foldNodeProp as $, foldInside as y, defineCSSCompletionSource as P, LanguageSupport as X, styleTags as m, tags as O, LRParser as c, ExternalTokenizer as S } from "../../../editor.js";
...
const W = /* @__PURE__ */ new S((T, Q) => {
  if (T.next == 40) {
    let e = T.peek(-1);
    (a(e) || p(e) || e == 95 || e == 45) && T.acceptToken(s, 1);
  }
}), d = /* @__PURE__ */ new S((T) => {
  if (r.indexOf(T.peek(-1)) > -1) {
    let { next: Q } = T;
    (a(Q) || Q == 95 || Q == 35 || Q == 46 || Q == 91 || Q == 58 || Q == 45) && T.acceptToken(f);
  }
}), Z = /* @__PURE__ */ new S((T) => {
  if (r.indexOf(T.peek(-1)) < 0) {
    let { next: Q } = T;
    if (Q == 37 && (T.advance(), T.acceptToken(l)), a(Q)) {
      do
        T.advance();
      while (a(T.next));
      T.acceptToken(l);
