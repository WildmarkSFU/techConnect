import { ContextTracker as Z, ExternalTokenizer as k, styleTags as N, tags as $, LRParser as Y, LRLanguage as A, indentNodeProp as I, foldNodeProp as j, bracketMatchingHandle as U, LanguageSupport as z, syntaxTree as q } from "../../../editor.js";
const C = 1, D = 2, M = 3, B = 4, F = 5, J = 35, H = 36, K = 37, L = 11, ee = 13;
function te(e) {
...
const ne = new Z({
  start: null,
  shift(e, t, n, O) {
    return t == C ? new x(b(O, 1) || "", e) : e;
  },
  reduce(e, t) {
    return t == L && e ? e.parent : e;
  },
  reuse(e, t, n, O) {
    let a = t.type.id;
    return a == C || a == ee ? new x(b(O, 1) || "", e) : e;
  },
  hash(e) {
    return e ? e.hash : 0;
  },
...
const re = W(J, "-->"), le = W(H, "?>"), oe = W(K, "]]>"), se = N({
  Text: $.content,
